...
def main():
    ...
    print("Accuracy of classification algorithum with Decision Tree classifier is ",Accuracy*100,"%")

    Accuracy = MarvellousCalculateAccuracyKNeighbor()
    print("Accuracy of classification algorithum with K Neighbor classifier is ",Accuracy*100,"%")
